package com.randomnoun.build.mojo.bamboo;
        ...
        throws MojoExecutionException
    {
    	...
    	try {
    		...
    		if (bambooRestUsername!=null && bambooRestPassword!=null) {
    			getLog().info("Authenticating with username '" + bambooRestUsername + "'");
    			getLog().info("Authenticating with password '" + bambooRestPassword + "'");
